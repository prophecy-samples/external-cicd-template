...
pipeline {
    ...
    environment {
        ...
        VENV_NAME = ".venv"
        FABRIC_ID = fabricPerBranch.getOrDefault(BRANCH_NAME, DEFAULT_FABRIC)
    }
    stages {
        stage('checkout') {
            steps {
                git branch: BRANCH_NAME, credentialsId: 'jenkins-cicd-runner-demo', url: 'git@github.com:SimpleDataLabsInc/HelloCICD.git'
